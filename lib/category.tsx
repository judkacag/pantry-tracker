...
const CATEGORY_META: [RegExp, CatMeta][] = [
  [/dairi|dairy|milk|milch|cheese|yog|joghurt|butter|cream|quark|egg/i,                                  { emoji: "🥛", bg: "#E4EDF1" }],
  ...
  [/bever|drink|juice|water|soda|tea|coffee|cola|smoothie/i,                                             { emoji: "🥤", bg: "#D4EBF5" }],
